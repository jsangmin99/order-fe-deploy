  ...
  methods:{
    async productCreate(){
      try {
        ...
        console.log(registerData.get("category"))
        console.log(registerData.get("price"))
        console.log(registerData.get("stockQuantity"))
        console.log(registerData.get("productImage"))


        await axios.post(`${process.env.VUE_APP_API_BASE_URI}/product/create`,registerData);
